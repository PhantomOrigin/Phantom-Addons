...
public final class PhaseLogger {
    ...
    public static void begin() {
        ...
        try {
            ...
            PhantomAddons.LOGGER.info("[PhantomAddons] Phase log started: {}", path);
        } catch (IOException e) {
            PhantomAddons.LOGGER.error("Failed to start phase log", e);
        }
    }
    ...
    public static void end() {
        try {
            ...
            PhantomAddons.LOGGER.error("Failed to close phase log", e);
        } finally {
            writer  = null;
            active  = false;
        }
    ...
    private static void writePlayerState(Minecraft client) {
        try {
            ...
            PhantomAddons.LOGGER.error("Failed writing player state", e);
        }
    }
}