package com.phantomaddons.features.supplies.giant;
...
public final class GiantHitboxOutline {
    ...
    public static void tick(Minecraft client) {
        if (!PhantomConfig.isGiantHitboxEnabled()) { outlined = Collections.emptySet(); return; }
    ...
    public static void render(PoseStack matrices, Camera camera, float tickDelta) {
        ...
        int fillA = Math.max(1, (int) (255f * PhantomConfig.getGiantHitboxFillOpacity()));
        boolean filled = PhantomConfig.isGiantHitboxFilled();
