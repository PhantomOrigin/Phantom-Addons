...
public final class KuudraHpHud {
    ...
    public static void register() {
        ...
        HudElementRegistry.attachElementBefore(VanillaHudElements.CHAT,
                ...
                (ctx, tc) -> {
                    if (!PhantomConfig.isKuudraHpHudEnabled()) return;
                    ...
                    float scale = PhantomConfig.getKuudraHpHudScale();
                    float cx = PhantomConfig.getKuudraHpHudX() * mc.getWindow().getGuiScaledWidth();
                    float cy = PhantomConfig.getKuudraHpHudY() * mc.getWindow().getGuiScaledHeight();
                    ...
                    boolean hideBar = PhantomConfig.isKuudraHpHideBar();
                    int half    = BAR_W / 2;
                    ...
                    String label;
                    if (PhantomConfig.isKuudraHpShowRaw()) {
    ...
    private static void updateDisplayValues() {
        ...
        int tier = com.phantomaddons.utils.KuudraTierDetector.getTier();
