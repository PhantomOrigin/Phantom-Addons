...
public final class GiantYLogger {
    ...
    private static void begin() {
        try {
            ...
            active = true;
            tickCounter = 0;
            KuudraHelperMod.LOGGER.info("[PhantomAddons] Giant Y log started: {}", path);
        } catch (IOException e) {
            KuudraHelperMod.LOGGER.error("Failed to start giant Y log", e);
        }
    }
    ...
    private static void end() {
        ...
        try {
            ...
            KuudraHelperMod.LOGGER.error("Failed to close giant Y log", e);
        } finally {
            writer = null;
            active = false;
        }
    ...
    private static void writeLine(Giant nearest, double distSq) {
        try {
            ...
            KuudraHelperMod.LOGGER.error("Failed writing giant Y log", e);
        }
    }
}
