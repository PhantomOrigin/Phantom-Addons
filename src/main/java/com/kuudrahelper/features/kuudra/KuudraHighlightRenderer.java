...
public final class KuudraHighlightRenderer {
    ...
    public static void render(PoseStack matrices, Camera camera, float tickDelta) {
        if (!KuudraConfig.isKuudraHighlightEnabled()) return;
        ...
        boolean filled = KuudraConfig.isKuudraHighlightFilled();
        ...
        for (Entity entity : mc.level.entitiesForRendering()) {
            ...
            // Fill: normal depth test (blocked by blocks)
            if (filled) {
            ...
            // Outline: visible through blocks
