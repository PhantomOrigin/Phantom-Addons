...
public final class SupplyRenderHelper {
    ...
    public static void render(PoseStack matrices, Camera camera, float tickDelta) {
        boolean showHitbox     = KuudraConfig.isSupplyHitboxEnabled();
        boolean showRodRadius  = KuudraConfig.isSupplyRodRadiusEnabled();
        boolean showPearlHitbox = KuudraConfig.isSupplyPearlHitboxEnabled();
