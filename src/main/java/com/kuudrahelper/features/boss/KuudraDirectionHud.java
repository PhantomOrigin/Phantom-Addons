...
public final class KuudraDirectionHud {
    ...
    public static void register() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            if (client.level == null || !KuudraConfig.isKuudraDirectionEnabled()) {
                direction = null;
                active    = false;
                return;
            }
        ...
        HudElementRegistry.attachElementBefore(VanillaHudElements.CHAT,
            ...
            if (!KuudraConfig.isKuudraDirectionEnabled()) return;
            String d = direction;
            if (d == null) return;
            ...
            float cx = KuudraConfig.getDirectionHudX() * screenW;
            float cy = KuudraConfig.getDirectionHudY() * screenH;
            float scale = 3.5f * KuudraConfig.getDirectionHudScale();
