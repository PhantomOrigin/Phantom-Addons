...
import com.kuudrahelper.features.misckuudra.profile.AutoKickManager;
import com.kuudrahelper.features.misckuudra.profile.KuudraProfileFetcher;
...
public final class PartyCommands {
    ...
    private static void handle(String raw) {
        ...
        if (youJoined.find()) {
            ...
            com.kuudrahelper.features.misckuudra.splits.KuudraSplitTimer.resetPartySession();
            return;
        }
