...
import com.kuudrahelper.features.misckuudra.profile.KuudraProfileData.ItemInfo;
    ...
    public static void fetchAsync(String playerName, Consumer<KuudraProfileData> callback) {
        ...
        CompletableFuture.runAsync(() -> {
            ...
            try {
                ...
                KuudraHelperMod.LOGGER.warn("[KuudraProfile] Fetch failed for {}: {}", playerName, e.toString());
            }
